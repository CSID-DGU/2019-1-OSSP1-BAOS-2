...
CTexture* g_pTexture = NULL;
CSprite* g_pSprite = NULL;
CCamera* g_pCamera = NULL;
CGameFontMgr* g_pGameFontMgr = NULL;
CMouse* g_pMouse = NULL;
CDebug* g_pDebug = NULL;

CGameObjPool* g_pGameObjPool = NULL;
CGameObjMgr* g_pGameObjMgr = NULL;
CGameTileMgr* g_pGameTileMgr = NULL;
CGameStage* g_pStage = NULL;
...
INT WINAPI wWinMain(HINSTANCE, HINSTANCE, LPWSTR, int)
{
	...
	DXUTCreateWindow(L"Baos Game window");
